...
export class PrivateEntityManager {
  ...
  getIndexComponents(entityToken, indexToken) {
    // When indexToken is undefined/null, return the base table primary key
    // components. This supports queries against the main table (no GSI).
    if (indexToken == null) return ['entityPK', 'entitySK'];
