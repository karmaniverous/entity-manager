...
export class EntityManager {
   ...
   * @param {object} [options.config] - EntityManager configuration object (see {@link https://github.com/VeteranCrowd/entity-manager/blob/main/lib/EntityManager/EntityManager.test.js unit tests} for an example).
