...
#### [v8.0.1](https://github.com/karmaniverous/entity-manager/compare/v8.0.0...v8.0.1)

- chore: update all dependencies to latest [`#10`](https://github.com/karmaniverous/entity-manager/pull/10)
- chore: move changelog generation to after:bump hook [`#8`](https://github.com/karmaniverous/entity-manager/pull/8)
- chore: add npm-pack-check CI workflow [`#7`](https://github.com/karmaniverous/entity-manager/pull/7)
- fix: sort indexTokens before rehydrate to prevent paging corruption [`#6`](https://github.com/karmaniverous/entity-manager/pull/6)
- cleanup [`37bb56a`](https://github.com/karmaniverous/entity-manager/commit/37bb56a993f3d939f52ed2048cc2d8e9d3f8d365)
- stan imports [`25cbb9c`](https://github.com/karmaniverous/entity-manager/commit/25cbb9cdb5fd2a9ef7f3dbda21dc39c9db049a81)
- updated docs [`814db90`](https://github.com/karmaniverous/entity-manager/commit/814db90c9db22d03f3db5bd1bf77a596e706a294)
- docs: fix typedoc notDocumented warnings [`c892b69`](https://github.com/karmaniverous/entity-manager/commit/c892b69a8cf284b3d8da8482510550922b068cde)
- docs: clear remaining typedoc warnings [`08d9bd4`](https://github.com/karmaniverous/entity-manager/commit/08d9bd4864b20246d8aae1c74e9faf12b2d8b2f1)
- ni [`d2ff954`](https://github.com/karmaniverous/entity-manager/commit/d2ff954ea0261727cdbac42b98076fc3e0181656)
- chore: add copilot review instructions [`f7a32cf`](https://github.com/karmaniverous/entity-manager/commit/f7a32cfd60756c7d06c051fdae778c427acbf368)
- [ISSUE-5] fix: sort indexTokens before rehydrate to prevent paging corruption (#5) [`a6e598a`](https://github.com/karmaniverous/entity-manager/commit/a6e598af61653846c7fa21fe1026073fa1c089ea)
- docs: clear final TypeDoc warnings [`42343d8`](https://github.com/karmaniverous/entity-manager/commit/42343d86678c71a83a80c53b4a52e1c40b81cb11)
- fix: unblock docs by aligning ParsedTranscoder [`5e1e19b`](https://github.com/karmaniverous/entity-manager/commit/5e1e19b8274356093cb3bd0b5d435e8c812b6839)
- chore: add npm publish safety net (.npmignore + gitignore *.local) [`76b29d6`](https://github.com/karmaniverous/entity-manager/commit/76b29d681a4c1661040d53008bbd579ad5322543)

### [v8.0.0](https://github.com/karmaniverous/entity-manager/compare/v8.0.0-0...v8.0.0)

> 1 December 2025

- chore: release v8.0.0 [`1582cf6`](https://github.com/karmaniverous/entity-manager/commit/1582cf60aa2853c0b9ddb94487a3d96eb27927d6)
...
#### [v2.1.0](https://github.com/karmaniverous/entity-manager/compare/v2.0.0...v2.1.0)
...
### [v1.0.0](https://github.com/karmaniverous/entity-manager/compare/v0.1.2-1...v1.0.0)
